...
public class ControladorPantallaPrincipal2 implements Initializable, MapComponentInitializedListener {
    ...
    public void mapInitialized() {
        ...
        */
        ...
        map = mapView2.createMap(mapOptions,false);
        ...
        */
        ...
        try {
            ...
            }, new DirectionsRenderer(true, map, mapView2.getDirec()));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
